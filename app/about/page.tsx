...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about Weglio, your trusted wholesale tech partner.",
};
    ...
    <div className="bg-white">
      <section className="bg-gradient-to-r from-gray-900 to-red-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-3xl font-bold">About Weglio</h1>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="space-y-3 text-gray-600">
                <p>Weglio was founded in 2017 in Stockholm with one goal: make quality tech accessible at fair prices.</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="p-5 bg-red-50 rounded-xl text-center">
                  <div className="text-2xl font-bold text-red-600">{s.n}</div>
      ...
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {[
              { y: "2017", t: "Founded in Stockholm" },
              { y: "2018", t: "Expanded into audio products" },
              { y: "2019", t: "Launched international shipping" },
              { y: "2022", t: "Reached 500+ customers" },
              { y: "2025", t: "2,600+ products in catalogue" },
            ].map((m, i) => (
              <div key={i} className="flex gap-4 items-center">
                <span className="text-red-600 font-bold w-14">{m.y}</span>
      ...
      <section className="bg-red-600 py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-red-100 mb-5">Join our network of satisfied customers</p>
          <Link href="/contact" className="px-6 py-2.5 bg-white text-red-600 font-medium rounded-lg hover:bg-red-50">
            Get in Touch
          </Link>
        </div>
      </section>
